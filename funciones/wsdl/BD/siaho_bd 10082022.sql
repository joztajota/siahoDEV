...
-- ----------------------------
INSERT INTO `dg_empleados` VALUES ('13336768', '13336768', 'UsuarioMoron', '12345', 'MORONUSER', 'Consultor', 'COnsultor MPS', 'Prueba', '2022-07-28', '1', '1');
INSERT INTO `dg_empleados` VALUES ('13336769', '13336769', 'UsuarioJAA', '12345', 'JAAUSER', 'Consulto', 'Consultor PMS', 'prueba', '2022-07-28', '1', '2');
INSERT INTO `dg_empleados` VALUES ('13336770', '1954558', 'jonathan', '12345', 'AMCUSER', 'Consultor', 'Consultor MPS', 'Prueba', '2022-07-28', '1', '4');
...
-- ----------------------------
INSERT INTO `dg_r24htabs` VALUES ('1', 'Revisión de Unidades de Emergencias jsantana', '1', '1');
...
INSERT INTO `dg_r24h_precarga` VALUES ('6', '1', '2', '2');

-- ----------------------------
-- Table structure for dg_recomendaicones
-- ----------------------------
DROP TABLE IF EXISTS `dg_recomendaicones`;
CREATE TABLE `dg_recomendaicones` (
  `recomendacionesId` int(11) NOT NULL,
  `responsableNumPersonal` int(11) DEFAULT NULL,
  `descripcion` text COLLATE utf8_turkish_ci,
  `fechaCreacion` date DEFAULT NULL,
  `fechaInicio` date DEFAULT NULL,
  `fechaPlanificaicon` date DEFAULT NULL,
  `estatus` varchar(5) COLLATE utf8_turkish_ci DEFAULT NULL,
  PRIMARY KEY (`recomendacionesId`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;

-- ----------------------------
-- Records of dg_recomendaicones
-- ----------------------------
...
-- ----------------------------
INSERT INTO `dm_complejo` VALUES ('1', 'CPM', 'D500', 'Complejo Morón/Hugo Chavez', 'MORON', 'MORON', 'CEN', '2014-05-29', '2014-05-29', 'superuser', 'superuser');
INSERT INTO `dm_complejo` VALUES ('2', 'CPAMC', 'B500', 'Complejo Ana María Campos', 'PUERTOS DE ALTAGRACIA', 'PUERTOS DE ALTAGRACIA', 'OCC', '2014-05-29', '2014-05-29', 'superuser', 'superuser');
INSERT INTO `dm_complejo` VALUES ('3', 'CORPORATIVO', 'A500', 'Sede Corporativa', 'CHACAO', 'CHACAO', 'CEN', '2014-05-29', '2014-05-29', 'superuser', 'superuser');
INSERT INTO `dm_complejo` VALUES ('4', 'CPJAA', 'C500', 'Complejo José Antonio Anzoátegui', 'PUERTO PIRITU', 'PUERTO PIRITU', 'ORI', '2015-02-12', '2015-02-12', 'superuser', 'superuser');
...
CREATE TABLE `dm_equipos` (
  ...
  `plantaId` int(11) DEFAULT NULL,
  `plantaIdSap` varchar(50) DEFAULT NULL,
  `EquipoCodSap` varchar(50) DEFAULT NULL,
  `nombre` varchar(255) DEFAULT NULL,
  `descripcion` varchar(255) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `dm_equipos` VALUES ('1', '1', 'D500', '1', 'NPK', '1030325', 'INT-40814 INTERRUPTOR SALIDA AL 417T0', 'INT-40814 INTERRUPTOR SALIDA AL 417T1', 'ELE-NPK');
INSERT INTO `dm_equipos` VALUES ('2', '1', 'D500', '2', 'FOS', '1030581', 'MVF-01O VIBRADOR CANALETA O', 'MVF-01O VIBRADOR CANALETA O', 'ELE-FOS');
INSERT INTO `dm_equipos` VALUES ('3', '2', 'B500', '3', 'PV2', '1035896', 'GEN-1:GENERADOR DE EMERGENCIA', 'GEN-1:GENERADOR DE EMERGENCIA', 'ELE-PVC2\r\n');
INSERT INTO `dm_equipos` VALUES ('4', '2', 'B500', '4', 'OL2', '1036004', 'RV-4305:VÁLVULA DE SEGURIDAD DE E-4303', 'RV-4305:VÁLVULA DE SEGURIDAD DE E-4304', 'INS-OLE2\r\n');
INSERT INTO `dm_equipos` VALUES ('5', '4', 'C500', '5', 'PAP', '1062962', 'LS-SH-801: INTERRUPTOR  DE NIVEL', 'LS-SH-801: INTERRUPTOR  DE NIVEL', 'INS-PAP\r\n');
INSERT INTO `dm_equipos` VALUES ('6', '4', 'C500', '5', 'PAP', '1063024', 'VALVULA COMPUERTA 4 PLG', 'VALVULA COMPUERTA 4 PLG', 'MEC-PAP\r\n');
INSERT INTO `dm_equipos` VALUES ('7', '4', 'C500', '7', 'SEL', '1063168', 'R03A: TABLERO 8Pu PROTE. 87L FERTINITRO', 'R03A: TABLERO 8Pu PROTE. 87L FERTINITRO', 'ELE-SEL\r\n');
INSERT INTO `dm_equipos` VALUES ('8', '1', 'D500', '8', 'SE2', '1077099', 'C-CQ1001-GA6A DOSIFICADORA ACIDO SULFURI', 'C-CQ1001-GA6A DOSIFICADORA ACIDO SULFURI', 'ELE-SIN2\r\n');
...
-- ----------------------------
INSERT INTO `dm_gerencia` VALUES ('1', 'TI', '2', 'B500', '11903', 'AIT.A', 'aitam', '2');
INSERT INTO `dm_gerencia` VALUES ('2', 'ASUNTOS LEGALES', '2', 'B500', '13823', 'AL.A', 'alamc', '2');
INSERT INTO `dm_gerencia` VALUES ('3', 'SALUD', '2', 'B500', '13821', 'AM.A', 'salam', '2');
INSERT INTO `dm_gerencia` VALUES ('4', 'ASUNTOS PÚBLICOS', '2', 'B500', '11025', 'AP.A', 'aappc', '2');
INSERT INTO `dm_gerencia` VALUES ('5', 'FORMACIÓN Y CAPACITACIÓN', '2', 'B500', '13005', 'FO.A', 'captc', '2');
INSERT INTO `dm_gerencia` VALUES ('6', 'PREVENCIÓN Y CONTROL DE PÉRDIDAS', '2', 'B500', '13840', 'PCP.A', 'pcpam', '2');
INSERT INTO `dm_gerencia` VALUES ('7', 'DESARROLLO SOCIAL', '2', 'B500', '13102', 'DS.A', 'dicam', '2');
INSERT INTO `dm_gerencia` VALUES ('8', 'DIRECCIÓN DE PROYECTO', '2', 'B500', '0', 'DP.A', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('9', 'FINANZAS', '2', 'B500', '13801', 'FI.A', 'fiamc', '2');
INSERT INTO `dm_gerencia` VALUES ('10', 'MANTENIMIENTO', '2', 'B500', '13164', 'MANT.A', 'gmamc', '2');
INSERT INTO `dm_gerencia` VALUES ('11', 'MATERIALES', '2', 'B500', '13231', 'MAT.A', 'mtamc', '2');
INSERT INTO `dm_gerencia` VALUES ('12', 'PRODUCCIÓN', '2', 'B500', '13388', 'PROD.A', 'gpamc', '2');
INSERT INTO `dm_gerencia` VALUES ('13', 'GESTIÓN HUMANA', '2', 'B500', '13807', 'RRHH.A', 'rhhm', '2');
INSERT INTO `dm_gerencia` VALUES ('14', 'SEGURIDAD INDUSTRIAL, AMBIENTE E  HIGIENE', '2', 'B500', '13233', 'SHA.A', 'shaam', '2');
INSERT INTO `dm_gerencia` VALUES ('15', 'SERVICIOS GENERALES', '2', 'B500', '13827', 'SG.A', 'gsamc', '2');
INSERT INTO `dm_gerencia` VALUES ('16', 'SISTEMA INTEGRADO DE GESTIÓN', '2', 'B500', '13894', 'SIG.A', 'sigco', '1');
INSERT INTO `dm_gerencia` VALUES ('17', 'SUMINISTRO', '2', 'B500', '13284', 'SUM.A', 'suamc', '2');
INSERT INTO `dm_gerencia` VALUES ('18', 'TÉCNICA', '2', 'B500', '13218', 'TEC.A', 'gtamc', '2');
INSERT INTO `dm_gerencia` VALUES ('19', 'UNOP', '2', 'B500', '13600', 'LOP.A', 'gunop', '1');
INSERT INTO `dm_gerencia` VALUES ('20', 'SERVICIOS GENERALES Y LOGÍSTICOS', '3', 'A500', '11827', 'ADSE.V', 'adsco', '1');
INSERT INTO `dm_gerencia` VALUES ('21', 'TI', '3', 'A500', '11093', 'AIT.V', 'aitco', '1');
INSERT INTO `dm_gerencia` VALUES ('22', 'SALUD', '3', 'A500', '11820', 'AM.V', 'salco', '1');
INSERT INTO `dm_gerencia` VALUES ('23', 'ASUNTOS PÚBLICOS', '3', 'A500', '11025', 'AP.V', 'aappc', '1');
INSERT INTO `dm_gerencia` VALUES ('24', 'AUDITORÍA INTERNA', '3', 'A500', '11055', 'AI.V', 'auico', '1');
INSERT INTO `dm_gerencia` VALUES ('25', 'FORMACIÓN Y CAPACITACIÓN', '3', 'A500', '11005', 'FO.V', 'captc', '1');
INSERT INTO `dm_gerencia` VALUES ('26', 'ASUNTOS LEGALES', '3', 'A500', '11030', 'AL.V', 'cjuco', '1');
INSERT INTO `dm_gerencia` VALUES ('27', 'PREVENCIÓN Y CONTROL DE PÉRDIDAS', '3', 'A500', '11840', 'PCP.V', 'pcpco', '1');
INSERT INTO `dm_gerencia` VALUES ('28', 'CONTROL DE GESTIÓN DE OFICINA DE LA PRESIDENCIA', '3', 'A500', '11004', 'OP.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('29', 'DESARROLLO SOCIAL', '3', 'A500', '11150', 'DS.V', 'dsoco', '1');
INSERT INTO `dm_gerencia` VALUES ('30', 'DIRECCIÓN DE PROYECTO', '3', 'A500', '11257', 'DP.V', 'direp', '1');
INSERT INTO `dm_gerencia` VALUES ('31', 'FINANZAS', '3', 'A500', '11009', 'FI.V', 'finco', '1');
INSERT INTO `dm_gerencia` VALUES ('32', 'JUNTA DIRECTIVA', '3', 'A500', '11001', 'JD.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('33', 'INVESTIGACIÓN Y DESARROLLO TECNOLÓGICO', '3', 'A500', '11849', 'IDT.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('34', 'OFICINA DESPACHO DE LA PRESIDENCIA', '3', 'A500', '11003', 'OP.V', 'gcgop', '1');
INSERT INTO `dm_gerencia` VALUES ('35', 'INVESTIGACIÓN Y DESARROLLO PETROQUÍMICO', '3', 'A500', '11026', 'ALBA.V', 'ggpin', '1');
INSERT INTO `dm_gerencia` VALUES ('36', 'PLANIFICACIÓN Y NUEVOS DESARROLLOS', '3', 'A500', '11038', 'PND.V', 'pndco', '1');
INSERT INTO `dm_gerencia` VALUES ('37', 'DESARROLLO ENDÓGENO PETROQUÍMICO', '3', 'A500', '0', 'PROD.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('38', 'PROYECTO NAVAY', '3', 'A500', '11240', 'P.NA.V', 'ggnav', '1');
INSERT INTO `dm_gerencia` VALUES ('39', 'PROYECTO PARAGUANA', '3', 'A500', '11245', 'P.PA.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('40', 'PROYECTO PUERTO NUTRIAS', '3', 'A500', '11256', 'P.PN.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('41', 'GESTIÓN HUMANA', '3', 'A500', '11017', 'RRHH.V', 'rhhco', '1');
INSERT INTO `dm_gerencia` VALUES ('42', 'SEGURIDAD INDUSTRIAL, AMBIENTE E  HIGIENE', '3', 'A500', '11037', 'SHA.V', 'shaco', '1');
INSERT INTO `dm_gerencia` VALUES ('43', 'CONTRATACIONES', '3', 'A500', '11057', 'CT.V', 'conco', '1');
INSERT INTO `dm_gerencia` VALUES ('44', 'SISTEMA INTEGRADO DE GESTIÓN', '3', 'A500', '11241', 'SIG.V', 'sigco', '1');
INSERT INTO `dm_gerencia` VALUES ('45', 'USLAF', '3', 'A500', '12600', 'UFER.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('46', 'TI', '4', 'C500', '11903', 'AIT.J', 'aitja', '2');
INSERT INTO `dm_gerencia` VALUES ('47', 'ASUNTOS LEGALES', '4', 'C500', '11030', 'AL.J', 'aljaa', '2');
INSERT INTO `dm_gerencia` VALUES ('48', 'SALUD', '4', 'C500', '14820', 'AM.J', 'salja', '2');
INSERT INTO `dm_gerencia` VALUES ('49', 'ASUNTOS PÚBLICOS', '4', 'C500', '11025', 'AP.J', 'aappj', '2');
INSERT INTO `dm_gerencia` VALUES ('50', 'FORMACIÓN Y CAPACITACIÓN', '4', 'C500', '14005', 'FO.J', 'captc', '2');
INSERT INTO `dm_gerencia` VALUES ('51', 'PREVENCIÓN Y CONTROL DE PÉRDIDAS', '4', 'C500', '14840', 'PCP.J', 'pcpja', '2');
INSERT INTO `dm_gerencia` VALUES ('52', 'DESARROLLO SOCIAL', '4', 'C500', '14613', 'DS.J', 'dicja', '2');
INSERT INTO `dm_gerencia` VALUES ('53', 'DIRECCIÓN DE PROYECTO', '4', 'C500', '11243', 'DP.J', 'tejaa', '2');
INSERT INTO `dm_gerencia` VALUES ('54', 'FINANZAS', '4', 'C500', '14801', 'FI.J', 'fijaa', '2');
INSERT INTO `dm_gerencia` VALUES ('55', 'GERENCIA GENERAL', '4', 'C500', '14800', 'GG.J', 'ggjaa', '1');
INSERT INTO `dm_gerencia` VALUES ('56', 'MANTENIMIENTO', '4', 'C500', '14269', 'MANT.J', 'majaa', '2');
INSERT INTO `dm_gerencia` VALUES ('57', 'MATERIALES', '4', 'C500', '12225', 'MAT.J', 'mtjaa', '2');
INSERT INTO `dm_gerencia` VALUES ('58', 'PRODUCCIÓN', '4', 'C500', '14247', 'PROD.J', 'prjaa', '2');
INSERT INTO `dm_gerencia` VALUES ('59', 'GESTIÓN HUMANA', '4', 'C500', '14889', 'RRHH.J', 'rhhj', '2');
INSERT INTO `dm_gerencia` VALUES ('60', 'SEGURIDAD INDUSTRIAL, AMBIENTE E  HIGIENE', '4', 'C500', '14233', 'SHA.J', 'shaja', '2');
INSERT INTO `dm_gerencia` VALUES ('61', 'SERVICIOS GENERALES', '4', 'C500', '14827', 'SG.J', 'sgjaa', '2');
INSERT INTO `dm_gerencia` VALUES ('62', 'SISTEMA INTEGRADO DE GESTIÓN', '4', 'C500', '14894', 'SIG.J', 'sigco', '1');
INSERT INTO `dm_gerencia` VALUES ('63', 'TÉCNICA', '4', 'C500', '14226', 'TEC.J', 'tejaa', '2');
INSERT INTO `dm_gerencia` VALUES ('64', 'ADMINISTRACIÓN COMERCIAL', '1', 'D500', '12709', 'UCOM.M', 'gfiac', '2');
INSERT INTO `dm_gerencia` VALUES ('65', 'ESTIMACIÓN DE COSTOS', '1', 'D500', '0', 'EC.M', 'escmo', '2');
INSERT INTO `dm_gerencia` VALUES ('66', 'TI', '1', 'D500', '11903', 'AIT.M', 'aitmo', '2');
INSERT INTO `dm_gerencia` VALUES ('67', 'ASUNTOS LEGALES', '1', 'D500', '11030', 'AL.M', 'alcpm', '2');
INSERT INTO `dm_gerencia` VALUES ('68', 'SALUD', '1', 'D500', '12820', 'AM.M', 'salmo', '2');
INSERT INTO `dm_gerencia` VALUES ('69', 'ASUNTOS PÚBLICOS', '1', 'D500', '11025', 'AP.M', 'aappm', '2');
INSERT INTO `dm_gerencia` VALUES ('70', 'AUDITORÍA INTERNA', '1', 'D500', '11055', 'AI.M', 'aifec', '2');
INSERT INTO `dm_gerencia` VALUES ('71', 'FORMACIÓN Y CAPACITACIÓN', '1', 'D500', '12005', 'FO.M', 'captc', '2');
INSERT INTO `dm_gerencia` VALUES ('72', 'COMERCIO EXTERIOR', '1', 'D500', '12615', 'UIPS.M', 'ipslc', '1');
INSERT INTO `dm_gerencia` VALUES ('73', 'PREVENCIÓN Y CONTROL DE PÉRDIDAS', '1', 'D500', '12840', 'PCP.M', 'pcpmo', '2');
INSERT INTO `dm_gerencia` VALUES ('74', 'DESARROLLO SOCIAL', '1', 'D500', '12150', 'DS.M', 'desmo', '2');
INSERT INTO `dm_gerencia` VALUES ('75', 'DIRECCIÓN DE PROYECTO', '1', 'D500', '0', 'DP.M', 'gprym', '1');
INSERT INTO `dm_gerencia` VALUES ('76', 'FINANZAS', '1', 'D500', '12801', 'FI.M', 'ficpm', '2');
INSERT INTO `dm_gerencia` VALUES ('77', 'GERENCIA GENERAL', '1', 'D500', '12101', 'GG.M', 'ggmor', '1');
INSERT INTO `dm_gerencia` VALUES ('78', 'LOGÍSTICA', '1', 'D500', '12703', 'ULOG.M', 'glogc', '1');
INSERT INTO `dm_gerencia` VALUES ('79', 'MANTENIMIENTO', '1', 'D500', '12164', 'MANT.M', 'manmo', '2');
INSERT INTO `dm_gerencia` VALUES ('80', 'MATERIALES', '1', 'D500', '12225', 'MAT.M', 'manmo', '2');
INSERT INTO `dm_gerencia` VALUES ('81', 'MERCADEO', '1', 'D500', '12614', 'UMER.M', 'gmerun', '2');
INSERT INTO `dm_gerencia` VALUES ('82', 'PLANIFICACIÓN', '1', 'D500', '12618', 'UPLA.M', 'ufpla', '2');
INSERT INTO `dm_gerencia` VALUES ('83', 'PLANTA DE DISTRIBUCIÓN TERMINAL BORBURATA', '1', 'D500', '14627', 'UBOR.M', 'pidtb', '2');
INSERT INTO `dm_gerencia` VALUES ('84', 'PRODUCCIÓN', '1', 'D500', '12112', 'PROD.M', 'prodmo', '2');
INSERT INTO `dm_gerencia` VALUES ('85', 'GESTIÓN HUMANA', '1', 'D500', '12807', 'RRHH.M', 'rhhm', '2');
INSERT INTO `dm_gerencia` VALUES ('86', 'SEGURIDAD INDUSTRIAL, AMBIENTE E  HIGIENE', '1', 'D500', '12306', 'SHA.M', 'shamo', '2');
INSERT INTO `dm_gerencia` VALUES ('87', 'SERVICIOS GENERALES', '1', 'D500', '12814', 'SG.M', 'adsmo', '2');
INSERT INTO `dm_gerencia` VALUES ('88', 'SISTEMA INTEGRADO DE GESTIÓN', '1', 'D500', '12894', 'SIG.M', 'sigco', '1');
INSERT INTO `dm_gerencia` VALUES ('89', 'SUMINISTRO', '1', 'D500', '12119', 'SUM.M', 'summo', '2');
INSERT INTO `dm_gerencia` VALUES ('90', 'TÉCNICA', '1', 'D500', '12316', 'TEC.M', 'tecmo', '2');
INSERT INTO `dm_gerencia` VALUES ('91', 'UNFER', '1', 'D500', '12600', 'UFER.M', 'unfer', '1');
INSERT INTO `dm_gerencia` VALUES ('92', 'UNPI/COPEQUIN', '4', 'C500', '14600', 'UCPI.M', 'gunpi', '1');
INSERT INTO `dm_gerencia` VALUES ('94', 'TRANSPORTE AÉREO', '3', 'A500', '0', 'TA.M', 'traae', '1');
INSERT INTO `dm_gerencia` VALUES ('93', 'GERENCIA GENERAL', '2', 'B500', '0', 'GG.M', 'ggamc', '1');
INSERT INTO `dm_gerencia` VALUES ('98', 'ASIGNADOS', '3', 'A500', '11810', 'ASIG.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('96', 'ASIGNADOS', '2', 'B500', '13810', 'ASIG.A', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('97', 'ASIGNADOS', '4', 'C500', '14844', 'ASIG.J', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('95', 'ASIGNADOS', '1', 'D500', '12810', 'ASIG.M', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('100', 'ESTIMACIÓN DE COSTOS', '4', 'C500', '14015', 'EC.J', 'ecjaa', '2');
INSERT INTO `dm_gerencia` VALUES ('99', 'ESTIMACIÓN DE COSTOS', '2', 'B500', '13015', 'EC.A', 'ecamc', '2');
INSERT INTO `dm_gerencia` VALUES ('101', 'ESTIMACIÓN DE COSTOS', '3', 'A500', '11015', 'EC.V', 'escco', '1');
INSERT INTO `dm_gerencia` VALUES ('102', 'PROYECTOS OPERACIONALES', '2', 'B500', '13253', 'PO.A', 'pryop', '2');
INSERT INTO `dm_gerencia` VALUES ('103', 'PLANIFICACIÓN Y NUEVOS DESARROLLOS', '2', 'B500', '13349', 'PND.A', 'pndco', '1');
INSERT INTO `dm_gerencia` VALUES ('105', 'PLANIFICACIÓN Y NUEVOS DESARROLLOS', '4', 'C500', '14350', 'PND.J', 'pndco', '1');
INSERT INTO `dm_gerencia` VALUES ('104', 'PLANIFICACIÓN Y NUEVOS DESARROLLOS', '1', 'D500', '12350', 'PND.M', 'pndco', '1');
INSERT INTO `dm_gerencia` VALUES ('106', 'TECNOLOGÍA Y NVOS.DESARROLLOS', '1', 'D500', '12619', 'TND.M', 'gtecnd', '2');
INSERT INTO `dm_gerencia` VALUES ('107', 'CONTRATACIONES', '2', 'B500', '13165', 'CT.A', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('108', 'CONTRATACIONES', '4', 'C500', '14830', 'CT.J', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('109', 'CONTRATACIONES', '1', 'D500', '12057', 'CT.M', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('110', 'CONFIABILIDAD', '1', 'D500', '12240', 'CF.M', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('111', 'CONFIABILIDAD', '2', 'B500', '13008', 'CF.A', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('112', 'PARADA DE PLANTAS', '2', 'B500', '13104', 'PP.A', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('113', 'DIRECCIÓN COMERCIAL', '3', 'A500', '11058', 'DC.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('114', 'DIRECCIÓN EJECUTIVA DE GESTIÓN Y PROTECCIÓN INTEGRAL', '3', 'A500', '11059', 'DEGPI.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('115', 'DIRECCIÓN NACIONAL DE OPERACIONES PETROQUÍMICAS', '3', 'A500', '11060', 'DNOP.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('116', 'PROTECCIÓN EMPRESARIAL', '3', 'A500', '11843', 'PCP.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('117', 'GERENCIA DE PRODUCCIÓN FERTILIZANTES', '4', 'C500', '14802', 'FERT-GPF.J', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('118', 'DIREC EJC PLANIF EVAL Y CONTR DE GESTION', '3', 'A500', '11061', 'DEPCJ.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('119', 'GCIA CORP PLAN EVAL Y CONTR DE EEMM Y FL', '3', 'A500', '11062', 'GCPECEMF.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('120', 'PALMICHAL- OFICINA PRINCIPAL', '3', 'A500', '11160', 'POP.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('121', 'PALMICHAL-GCIA OPERA REG CENTRAL', '1', 'D500', '12009', 'PGORC.M', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('122', 'PALMICHAL-GCIA OCCIDENTE', '2', 'B500', '13009', 'PGOC.A', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('123', 'PALMICHAL-GCIA ORIENTE', '4', 'C500', '14009', 'PGOR.A', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('124', 'GCIA. CORP. DE CONTRALORIA FINANCIERA', '3', 'A500', '11102', 'CF.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('125', 'GCIA. CORP. DE PLANIF.Y C. DE G. DE FNZ', '3', 'A500', '11103', 'PCF.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('126', 'GCIA. CORP. DE COSTOS Y EVAL. ECONÓMICAS', '3', 'A500', '11104', 'CEE.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('127', 'Gcia. Corp. EEMMFF  y  Asoc. Especiales.', '3', 'A500', '11064', 'EEAE.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('128', 'GCIA.DE SEGUIMIENTO Y CONT. PRESIDENCIAL', '3', 'A500', '11063', 'GSCP.V', 'NA', '0');
INSERT INTO `dm_gerencia` VALUES ('129', 'SUPERINTENDENCIA DE PARADAS DE PLANTAS Y PROYECTOS MAYORES', '4', 'C500', '14051', 'SPPM.J', 'NA', '0');

-- ----------------------------
-- Table structure for dm_gerencia_custodio_copy
-- ----------------------------
DROP TABLE IF EXISTS `dm_gerencia_custodio_copy`;
CREATE TABLE `dm_gerencia_custodio_copy` (
  `gerenciaCustorioId` int(11) NOT NULL,
  ...
  `email` varchar(255) DEFAULT NULL,
  `activo` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`gerenciaCustorioId`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of dm_gerencia_custodio_copy
-- ----------------------------
...
CREATE TABLE `dm_planta` (
  ...
  `complejoId` int(11) DEFAULT NULL,
  `complejoIDSAP` varchar(50) DEFAULT NULL,
  `plantaIdSAP` varchar(50) DEFAULT NULL,
  `nombre` varchar(255) DEFAULT NULL,
  `descripcion` varchar(255) DEFAULT NULL,
  `fecha` date DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `dm_planta` VALUES ('1', '1', 'D500', 'NPK', 'NPK', 'NPK', '2022-08-09');
INSERT INTO `dm_planta` VALUES ('2', '1', 'D500', 'FOS', 'Fosfórico', 'Fosfórico', '2022-08-09');
INSERT INTO `dm_planta` VALUES ('3', '2', 'B500', 'PV2', 'PVC II', 'PVC II', '2022-08-09');
INSERT INTO `dm_planta` VALUES ('8', '1', 'D500', 'EFL', 'Planta de Tratamiento de Efluente', 'Planta de Tratamiento de Efluente', '2022-08-09');
INSERT INTO `dm_planta` VALUES ('7', '4', 'C500', 'SEL', 'Sub Estacion Electrica', 'Sub Estacion Electrica', '2022-08-09');
INSERT INTO `dm_planta` VALUES ('5', '4', 'C500', 'PAP', 'Planta de Agua', 'Planta de Agua', '2022-08-09');
INSERT INTO `dm_planta` VALUES ('4', '2', 'B500', 'OL2', 'Olefinas II', 'Olefinas II', '2022-08-09');
...
-- ----------------------------
-- Table structure for rel_dgincidenciasbody_recomendaciones
-- ----------------------------
DROP TABLE IF EXISTS `rel_dgincidenciasbody_recomendaciones`;
CREATE TABLE `rel_dgincidenciasbody_recomendaciones` (
  `incidenciaHeaderId` int(11) NOT NULL,
  `incidenciaBodyId` int(11) NOT NULL,
  `recomendacionesId` int(11) NOT NULL,
  PRIMARY KEY (`incidenciaHeaderId`,`incidenciaBodyId`,`recomendacionesId`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;

-- ----------------------------
-- Records of rel_dgincidenciasbody_recomendaciones
-- ----------------------------
